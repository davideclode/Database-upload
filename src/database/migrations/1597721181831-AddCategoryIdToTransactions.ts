...
export default class AddCategoryIdToTransactions1597721181831
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(
      ...
      new TableForeignKey({
        columnNames: [
          'category_id',
        ] /* Nome da coluna que está na nossa tabela transactions */,
        referencedColumnNames: [
          'id',
        ] /* Lá na tabela categories, estaremos referenciando a coluna "id" */,
        referencedTableName:
          'categories' /* A tabela que estamos referenciando */,
        name: 'TransactionCategory' /* Apelido da nossa chave estrangeira */,
        onUpdate:
          'CASCADE' /* Sempre que atualizar em uma tabela, atualize também na outra */,
        onDelete: 'SET NULL',
      }),
    );
  }
